    ...
    return (
      <div className="p-6 md:p-10 max-w-4xl mx-auto text-center mt-20">
        ...
        <p className="text-[var(--muted-foreground)] mb-8 text-lg">
          You need a complete offer before you can start generating outreach.
        </p>
        <Link 
          href="/dashboard"
  ...
  return (
    <div className="p-6 md:p-10 max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-[var(--muted-foreground)]">Create personalized outreach instead of sending generic spam.</p>
      </div>

      <OutreachClient prospects={user.prospects} />
    </div>
  );
}
